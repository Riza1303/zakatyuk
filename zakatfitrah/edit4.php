<?php include('config.php'); ?>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_GET['id'])){
			...
			$select = mysqli_query($koneksi, "SELECT * FROM mustahik_warga WHERE id='$id'") or die(mysqli_error($koneksi));
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "UPDATE mustahik_warga SET nama='$nama', kategori='$kategori', hak='$hak' WHERE id='$id'") or die(mysqli_error($koneksi));
