...
?>
	...
	<div class="container" style="margin-top:20px">
		<center><font size="6">Data Muzakki</font></center>
		<hr>
		...
		<table class="table table-striped jambo_table bulk_action">
			...
			<tbody>
				...
				$sql = mysqli_query($koneksi, "SELECT * FROM muzakki ORDER BY id DESC") or die(mysqli_error($koneksi));
				...
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td>
								<a href="index.php?page=edit&id='.$data['id'].'" class="btn btn-secondary btn-sm">Edit</a>
